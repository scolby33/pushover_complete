...
def test_PushoverAPI_raises_error_on_bad_receipt(PushoverAPI):
    ...
    with pytest.raises(BadAPIRequestError):
        PushoverAPI.check_receipt(
            "r" + TEST_BAD_GENERAL_ID
        )  # needs to start with 'r' for the regex url match
...
def test_PushoverAPI_cancels_receipt(PushoverAPI):
    ...
    url_re = re.compile(
        r"https://api\.pushover\.net/1/receipts/r[a-zA-Z0-9]*/cancel\.json"
    )
    responses.add_callback(
        responses.POST,
        url_re,
...
def test_PushoverAPI_gets_group_info(PushoverAPI):
    ...
    responses.add_callback(
        responses.GET, url_re, callback=groups_callback, content_type="application/json"
    )
...
def test_PushoverAPI_adds_user_to_group(PushoverAPI):
    ...
    url_re = re.compile(
        r"https://api\.pushover\.net/1/groups/g[a-zA-Z0-9]*/add_user\.json"
    )
    responses.add_callback(
        responses.POST,
        url_re,
...
def test_PushoverAPI_deletes_user_from_group(PushoverAPI):
    ...
    url_re = re.compile(
        r"https://api\.pushover\.net/1/groups/g[a-zA-Z0-9]*/delete_user\.json"
    )
    responses.add_callback(
        responses.POST,
        url_re,
...
def test_PushoverAPI_disables_user_in_group(PushoverAPI):
    ...
    url_re = re.compile(
        r"https://api\.pushover\.net/1/groups/g[a-zA-Z0-9]*/disable_user\.json"
    )
    responses.add_callback(
        responses.POST,
        url_re,
...
def test_PushoverAPI_enables_user_in_group(PushoverAPI):
    ...
    url_re = re.compile(
        r"https://api\.pushover\.net/1/groups/g[a-zA-Z0-9]*/enable_user\.json"
    )
    responses.add_callback(
        responses.POST,
        url_re,
...
def test_PushoverAPI_changes_group_name(PushoverAPI):
    ...
    url_re = re.compile(
        r"https://api\.pushover\.net/1/groups/g[a-zA-Z0-9]*/rename\.json"
    )
    responses.add_callback(
        responses.POST,
        url_re,
