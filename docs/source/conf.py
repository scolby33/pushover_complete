...
parsed_version = re.match(r'(?P<major>\d+)\.(?P<minor>\d+)\.(?P<patch>\d+)(?:-(?P<release>[0-9A-Za-z-]+(?:\.[0-9A-Za-z-]+)*))?(?:\+(?P<build>[0-9A-Za-z-]+(?:\.[0-9A-Za-z-]+)*))?',
                          release)
...
latex_documents = [
    (master_doc, 'pushover_complete.tex', 'pushover\\_complete Documentation',
     'Scott Colby', 'manual'),
]
...
man_pages = [
    (master_doc, 'pushover_complete', 'pushover_complete Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pushover_complete', 'pushover_complete Documentation',
     author, 'pushover_complete', 'One line description of project.',
     'Miscellaneous'),
]
