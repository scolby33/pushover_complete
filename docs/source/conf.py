"""pushover_complete documentation build configuration file."""  # noqa: INP001 -- it's not a namespace package, it's a configuration script

# pushover_complete documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath("../../src"))  # noqa: PTH100 -- can't assume we'll have pathlib here
...
if parsed_version.group("release"):
    tags.add("prerelease")  # noqa: F821 -- tags is defined in the Sphinx execution environment
...
htmlhelp_basename = "pushover_completedoc"
...
man_pages = [(master_doc, "pushover_complete", "pushover_complete Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "pushover_complete",
        "pushover_complete Documentation",
        author,
        "pushover_complete",
...
if os.environ.get("READTHEDOCS", None):
    tags.add("readthedocs")  # noqa: F821 -- tags is defined in the Sphinx execution environmentoqa
